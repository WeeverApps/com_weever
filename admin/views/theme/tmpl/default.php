...
<form action='index.php' enctype='multipart/form-data' method='post' name='adminForm' id='adminForm'>
	...
	<div>
		...
		<option value="650"><?php echo JText::_('WEEVER_LAUNCH_ANIMATION_TIMEOUT_DEFAULT'); ?></option>
		...
		<option value="1350"><?php echo JText::_('WEEVER_LAUNCH_ANIMATION_DURATION_DEFAULT'); ?></option>
