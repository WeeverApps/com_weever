...
class ContentModelFrontpage extends JModel
{
	...
	function _buildQuery()
	{
		...
		$query = ' SELECT a.id, a.title, a.alias, a.title_alias, '.$content_html.' a.state, a.catid, a.created, a.created_by, a.created_by_alias, a.modified, a.modified_by,' .
			' a.checked_out, a.checked_out_time, a.publish_up, a.publish_down, a.images as image, a.attribs, a.urls, a.metakey, a.metadesc, a.access,' .
